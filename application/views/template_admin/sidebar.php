        ...
        <li class="nav-item">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="<?php echo base_url('admin/data_pegawai') ?>">Data Guru</a>
              ...
              <a class="collapse-item" href="<?php echo base_url('admin/data_mapel') ?>">Data Mapel</a>
              <a class="collapse-item" href="<?php echo base_url('admin/data_kelas') ?>">Data Kelas</a>
              <a class="collapse-item" href="<?php echo base_url('admin/data_jadwal') ?>">Data Jadwal</a>
            </div>
          </div>
        </li>
