...
<section class="content-header">
  <h1>
    ...
    <span class="pull-right-container">
      <a class="btn btn-sm btn-default pull-right" href="<?php echo base_url('admin/master_data/data_pegawai/') ?>"><i class="fa fa-arrow-left"></i> KEMBALI </a>
    </span>
  </h1>
</section>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <form method="POST" action="<?php echo base_url('admin/master_data/data_pegawai/tambah_aksi')?>" enctype="multipart/form-data">

          <div class="box-body">

            <div class="form-group <?= form_error('nuptk') ?>">
              <label for="nik">NUPTK</label>
              <input type="number" class="form-control" id="nik" placeholder="Masukkan NUPTK" name="nik" maxlength="16" minlength="16" required>
