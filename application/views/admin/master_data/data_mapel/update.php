  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <form method="POST" action="<?php echo base_url('admin/master_data/data_mapel/update_aksi')?>" enctype="multipart/form-data">

          <div class="box-body">

            <div class="form-group <?= form_error('id','has-error') ?>">
              <input type="hidden" class="form-control" id="id" placeholder="Masukkan Nama Mapel" name="id" value="<?= $mapel->id ?>">
            ...
            <div class="form-group <?= form_error('nama_mapel','has-error') ?>">
              ...
              <input type="text" class="form-control" id="nama_mapel" placeholder="Masukkan Nama Mapel" name="nama_mapel" value="<?= $mapel->nama_mapel ?>">
