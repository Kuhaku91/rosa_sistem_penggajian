  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <form method="POST" action="<?php echo base_url('admin/master_data/data_kelas/update_aksi')?>" enctype="multipart/form-data">

          <div class="box-body">

            <div class="form-group <?= form_error('id','has-error') ?>">
              <input type="hidden" class="form-control" id="id" placeholder="Masukkan Nama kelas" name="id" value="<?= $kelas->id ?>">
              <?= form_error('id','<span class="help-block"></span>') ?>
            </div>

            <div class="form-group <?= form_error('nama_kelas','has-error') ?>">
              <label class="control-label" for="nama_kelas">Kelas</label>
              <input type="text" class="form-control" id="nama_kelas" placeholder="Masukkan Nama Kelas" name="nama_kelas" value="<?= $kelas->nama_kelas ?>">
