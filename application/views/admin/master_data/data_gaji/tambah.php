  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <form method="POST" action="<?php echo base_url('admin/master_data/data_gaji/tambah_aksi')?>" enctype="multipart/form-data">

          <div class="box-body">

            <div class="form-group <?= form_error('nama_gaji','has-error') ?>">
              <label class="control-label" for="nama_gaji">Gaji</label>
              <input type="text" class="form-control" id="nama_gaji" placeholder="Masukkan Nama Gaji" name="nama_gaji">
            ...
            <div class="form-group <?= form_error('nominal','has-error') ?>">
              ...
              <input type="number" class="form-control" id="nominal" placeholder="Masukkan Nominal Gaji" name="nominal">
